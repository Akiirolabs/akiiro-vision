  ...
  return (
    <main onPointerMove={(event) => setCursor({
      ...
      <section className="contact" id="contact">
        ...
        <div className="contact-copy"><p>Intelligence should feel less artificial.</p><h2>Enter the<br /><em>thinking space.</em></h2><a href="mailto:support@akiiro.com">Request access <span>↗</span></a></div>
        <footer><a href="#top">AKIIRO®</a><span>© 2026 / ALL SYSTEMS CURIOUS</span><div className="contact-legal"><a href="/support">SUPPORT</a><a href="/privacy">PRIVACY</a><a href="/terms">TERMS</a></div><a href="#top">BACK TO TOP ↑</a></footer>
      </section>
    </main>
  );
}
