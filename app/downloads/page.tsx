  ...
  return (
    <main className="downloads-page">
      ...
      <section aria-labelledby="download-title">
        ...
        <a className="download-installer" href="https://downloads.akiiro.com/Macro-Kii-1.1.0-mac-arm64.dmg">Download for Mac <span>↓</span></a>
        <p className="download-version">Apple Silicon · Version 1.1.0 · .dmg</p>
        <details className="download-help">
          <summary>Installation instructions</summary>
          <ol><li>Download the installer using the button above.</li><li>Open Macro-Kii-1.1.0-mac-arm64.dmg from your Downloads folder.</li><li>Follow the installer’s instructions, then open Macro Kii.</li></ol>
