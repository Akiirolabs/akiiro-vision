...
const sections = [
  ...
  ["AI website chat", <><p>If you use the Ask Akiiro chat, the messages you submit and limited conversation context are sent to OpenAI to generate a response. When a message reports something broken or malfunctioning, the site may also save that message as a support record so Akiiro can diagnose the issue. Do not submit passwords, payment information, confidential material, health information, or other sensitive personal information through the chat.</p><p>The chat is an automated guide and may produce incomplete or inaccurate output. Akiiro requests that API responses are not stored as application state, but OpenAI may process API data under its applicable service terms and data-use policies.</p></>],
  ...
  ["Your privacy choices", <><p>Depending on where you live, you may have rights to request access, correction, deletion, restriction, portability, or information about how personal information is used. You may also object to or withdraw consent for certain processing.</p><p>To make a request, email <a href="mailto:support@akiiro.com">support@akiiro.com</a>. We may need to verify your identity before completing a request. You may also have the right to contact your local data protection authority.</p></>],
  ...
  ["Changes and contact", <><p>We may update this policy as the website, services, or legal requirements change. The effective date above identifies the latest version.</p><p>Questions or privacy requests may be sent to <a href="mailto:support@akiiro.com">support@akiiro.com</a>.</p></>],
] as const;
