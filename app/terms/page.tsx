...
const sections = [
  ...
  ["AI website chat", <><p>The Ask Akiiro chat uses an automated system to answer questions from a curated product reference. Its responses may be incomplete, inaccurate, or out of date and are provided for general information only.</p><p>Do not rely on chat output as professional advice or as a guarantee about product specifications, availability, pricing, policies, or performance. Confirm important information through the relevant product page, checkout, source material, or by contacting Akiiro.</p></>],
  ...
  ["Contact", <p>Questions about these Terms may be sent to <a href="mailto:support@akiiro.com">support@akiiro.com</a>.</p>],
] as const;
